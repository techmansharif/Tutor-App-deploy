...
def create_streaming_requests(text, language_code, voice_gender):
    ...
    # First request: Configuration with audio settings
    config_request = texttospeech.StreamingSynthesizeRequest(
        streaming_config=texttospeech.StreamingSynthesizeConfig(
            ...
            # Add this audio config - this was missing!
...
def text_to_speech_auto_language_streaming(text):
    ...
    try:
        ...
        # Save as WAV file instead of MP3
        filename = f"streaming_output_{detected_language}.wav"
